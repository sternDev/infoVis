...
define('graph-chart-diesel', ['jquery', 'd3-v3'], function ($, d3) {
    ...
    var graphChart = function (year) {
        ...
        this.year = year;
        this.id = "#dieselFlensburg";
        this.filename = "../data/created/diesel/diesel.csv";
        $(this.id).empty();
        this.createSvg();
    };
        ...
        this.svg.selectAll("dot")
            ...
            .on("mouseover", function (d) {
                div.transition()
                    .duration(200)
                    .style("opacity", .9);
                div.html(formatDate(d.DATE) + "<br/>" + d.VALUE/1000+" €")
